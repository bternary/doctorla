...
namespace Web.Resources
{
    public class SaglikcimApiService 
    {
        ...
        //public EncryptionMiddleware encryption;
        //private readonly IHttpContextAccessor _httpContextAccessor;
        public SaglikcimApiService(string baseUrl)
        {                                
            Client.Timeout = new TimeSpan(0, 0, 360);
            Client.DefaultRequestHeaders.Accept.Clear();
            Client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            //Client.BaseAddress = new Uri("http://preview.doctorla.co/api/");
            Client.BaseAddress = new Uri("http://localhost:51244/api/");
        }
        public SaglikcimApiService(string baseUrl,string token) 
        {      
            Client.Timeout = new TimeSpan(0, 0, 360);
            Client.DefaultRequestHeaders.Accept.Clear();
            Client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
